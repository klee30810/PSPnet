...
Filename: pspnet.py
Author: Kyungmin, Lee
Purpose: implementing pspnet
Created: 2020.01.11
Updated: 2020.01.13
Sources: copied from https://github.com/Lextal/pspnet-pytorch/blob/master/augmentation.py
"""
...
def train(data_path, models_path, backend, snapshot, crop_x, crop_y, batch_size, alpha, epochs, start_lr, milestones,
          gpu):
